...
const AdminDashBoard = () => {
    ...
    return (
        <>
            <div className='mt-5 ml-5 d-inline-block' >
                ...
                <NavLink to='/admin-makeadmin' className='font-weight-bold d-block' activeStyle={{ color: 'green' }}> <FontAwesomeIcon className='mr-2' icon={faUserPlus} />Make Admin </NavLink>
